...
public class Centre 
{
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		NUMBER_ISLANDS = 8;
		NUMBER_MIGRATIONS = 10;//	(CHANGE ME) //10000 was amazing (with 2500gens --- otherwise, wait like a day....)
		GENERATIONS = 1010000;// 
		NUMBER_GENES = 32;	//40 worked well // = 16; // = 32;
		...
		theData = Reader.readData("../resources/regression-data/", "d17.csv");		//CHANGE THE PREDICTOR SIZE IF USING THIS!!!
